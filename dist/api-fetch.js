...
var debug = require('debug')('chums:local-modules:api-fetch');
var _a = process.env, INTRANET_API_USERNAME = _a.INTRANET_API_USERNAME, INTRANET_API_PASSWORD = _a.INTRANET_API_PASSWORD;
var LOCAL_HOSTNAMES = ['localhost', 'intranet.chums.com'];
/**
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!options.headers.Authorization && LOCAL_HOSTNAMES.includes(url.hostname)) {
                        auth = Buffer.from(INTRANET_API_USERNAME + ":" + INTRANET_API_PASSWORD).toString('base64');
